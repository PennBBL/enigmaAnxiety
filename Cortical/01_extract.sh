#!/bin/bash
pushd .
cd /data/jux/BBL/projects/enigmaAnxiety/cortical_output
...
cat /data/jux/BBL/projects/enigmaAnxiety/subjectData/AllAnxTd_bblids_scanids.csv | while IFS="," read -r subj_id scanid ; do
	thisPath="/data/joy/BBL/studies/pnc/processedData/structural/freesurfer53/${subj_id}/*x${scanid}/"
...
printf "%g," `grep -w ${x} ${thisPath}/stats/${side} | awk '{print $5}'` >> CorticalMeasuresENIGMA_ThickAvg.csv
printf "%g," `grep -w ${x} ${thisPath}/stats/${side} | awk '{print $3}'` >> CorticalMeasuresENIGMA_SurfAvg.csv

done
done

printf "%g," `cat ${thisPath}/stats/lh.aparc.stats | grep MeanThickness | awk -F, '{print $4}'` >> CorticalMeasuresENIGMA_ThickAvg.csv
printf "%g," `cat ${thisPath}/stats/rh.aparc.stats | grep MeanThickness | awk -F, '{print $4}'` >> CorticalMeasuresENIGMA_ThickAvg.csv
printf "%g," `cat ${thisPath}/stats/lh.aparc.stats | grep MeanThickness | awk -F, '{print $4}'` >> CorticalMeasuresENIGMA_SurfAvg.csv
printf "%g," `cat ${thisPath}/stats/rh.aparc.stats | grep MeanThickness | awk -F, '{print $4}'` >> CorticalMeasuresENIGMA_SurfAvg.csv
printf "%g," `cat ${thisPath}/stats/lh.aparc.stats | grep WhiteSurfArea | awk -F, '{print $4}'` >> CorticalMeasuresENIGMA_ThickAvg.csv
printf "%g," `cat ${thisPath}/stats/rh.aparc.stats | grep WhiteSurfArea | awk -F, '{print $4}'` >> CorticalMeasuresENIGMA_ThickAvg.csv
printf "%g," `cat ${thisPath}/stats/lh.aparc.stats | grep WhiteSurfArea | awk -F, '{print $4}'` >> CorticalMeasuresENIGMA_SurfAvg.csv
printf "%g," `cat ${thisPath}/stats/rh.aparc.stats | grep WhiteSurfArea | awk -F, '{print $4}'` >> CorticalMeasuresENIGMA_SurfAvg.csv
printf "%g" `cat ${thisPath}/stats/aseg.stats | grep IntraCranialVol | awk -F, '{print $4}'` >> CorticalMeasuresENIGMA_ThickAvg.csv
printf "%g" `cat ${thisPath}/stats/aseg.stats | grep IntraCranialVol | awk -F, '{print $4}'` >> CorticalMeasuresENIGMA_SurfAvg.csv
