#Outlier Detection (last update Mar 2017 JMBH)
#DPH

#Read in the cortical thickness measures obtained from Step 1 of the protocols
dat=read.csv("LandRvolumes.csv",stringsAsFactors=FALSE)

#Check for duplicated SubjIDs
if(anyDuplicated(dat[,c("SubjID")]) != 0) { stop('You have duplicate SubjIDs in your ventralDC.csv file.\nMake sure there are no repeat SubjIDs.') }
